      ...
      <nav class="sidenav shadow-right sidenav-light">
        <div class="sidenav-menu">
          <div class="nav accordion" id="accordionSidenav">
            ...
            <?php 
                echo 
                    '<a class="nav-link active" href="Customer_Information(staff).php?userId='.$userId.'">
          ...
          <div class="card mb-4">
            <div class="card-header ps-3">
              <div style="width: 300px">
                <form class="d-flex" action="Customer_Information(staff).php?userId=<?php echo $userId?>" method="post">
