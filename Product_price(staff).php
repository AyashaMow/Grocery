      ...
      <nav class="sidenav shadow-right sidenav-light">
        <div class="sidenav-menu">
          <div class="nav accordion" id="accordionSidenav">
            ...
            <?php 
                echo 
                    '<a class="nav-link active" href="Product_price(staff).php?userId='.$userId.'">
                      <div class="nav-link-icon">
            ...
            <!-- Product Price end -->
             ...
             <!-- Feedback start -->
               <?php 
                echo 
                    '<a class="nav-link" href="Feedback(staff).php?userId='.$userId.'">
                      <div class="nav-link-icon">
                        ...
                        <div class="modal-dialog">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <form action="Product_price(staff).php?userId=<?php echo $userId ?>" method="post">
                        ...
                        <tbody>
                          <?php
                              foreach($tests as $test){
                                ...
                                echo '<td>
                                        <a class="btn btn-datatable btn-sm"  href="Delete/delete3(staff).php?id='.$test['id'].'&userId='.$userId.'"  title="Delete" >
                                ...
                                href="updatePrice(staff).php?id='.$test['id'].'&userId='.$userId.'"><i data-feather="edit"></i></a>
        ...
        <div class="container-xl px-4">
          <div class="row">
            <div class="col-md-6 small">
              Copyright &copy;yoursite@gmail.com
            </div>
          </div>
        </div>
      </footer>
